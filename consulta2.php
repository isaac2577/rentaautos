...
<?php
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta2.php?id_cliente=".$row['id_cliente']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar2.php?id_cliente=".$row['id_cliente']."'>
