...
<?php
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta3.php?id_compra=".$row['id_compra']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar3.php?id_compra=".$row['id_compra']."'>
