...
<th>Modificar</th>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta10.php?id_tarifa=".$row['id_tarifa']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar10.php?id_tarifa=".$row['id_tarifa']."'>
