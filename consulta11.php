...
<th>Modificar</th>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta11.php?id_ubicacion=".$row['id_ubicacion']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar11.php?id_ubicacion=".$row['id_ubicacion']."'>
