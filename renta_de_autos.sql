...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-08-2023 a las 20:30:56
...
CREATE TABLE `compras` (
  ...
  `modelo_carro` varchar(10) NOT NULL,
...
INSERT INTO `compras` (`id_compra`, `tipo_compra`, `modelo_carro`, `tipo_pago`, `monto`) VALUES
(4, '', 'Camaro', 'Tarjeta de debito', '38,00'),
(5, 'Familiar', 'Camaro', 'Tarjeta de debito', '38,00'),
(6, 'Familiar', 'Versa', 'Tarjeta', '38,00'),
(7, 'Deportivo', 'Chalenger', 'Efectivo', '38,00');
...
--
ALTER TABLE `compras`
  MODIFY `id_compra` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
