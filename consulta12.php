...
<th>Modificar</th>
 ...
 echo"<tr>";
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta12.php?id_usuario=".$row['id_usuario']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar12.php?id_usuario=".$row['id_usuario']."'>
