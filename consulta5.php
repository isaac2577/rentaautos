...
<?php
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta5.php?id_empleado=".$row['id_empleado']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar5.php?id_empleado=".$row['id_empleado']."'>
