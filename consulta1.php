...
if (mysqli_num_rows($result) > 0) {
  ...
  <div><?php echo"Bienvenid@:  ".$_SESSION["usuario"];?> </div> 
...
if (isset($_REQUEST['id_ciudad']))
{
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<td>"."<p> <a href='https://localhost/Basedatos/consulta1.php?id_ciudad=".$row['id_ciudad']."'>
    <img src='basura.png' alt='W3Schools.com' widt='38' height='38'>
    </a></p>";
    echo"<td>"."<p> <a href='https://localhost/Basedatos/modificar1.php?id_ciudad=".$row['id_ciudad']."'>
